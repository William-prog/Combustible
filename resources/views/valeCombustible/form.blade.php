    ...
    <div class="container">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" value="{{ $fechaActual->format('Y-m-d') }}"
                                id="valeFecha" name="valeFecha" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" placeholder="" name="valeCc" id="valeCc"
                                readonly>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-2">
                ...
                <input type="number" placeholder="" class="form-control" name="valePlacas" id="valePlacas">
            </div>
            <div class="col-md-6">
