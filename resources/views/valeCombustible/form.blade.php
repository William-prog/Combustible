...
<div class="container">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <input type="number" class="form-control" placeholder="" id="valeNumero" name="valeNumero">
                    </div>
                    <div class="col-md-6">
                        <label for="valeSolicitante" class="form-label">Solicitante:</label>
                        <input type="text" placeholder="" class="form-control" name="valeSolicitante" id="valeSolicitante">
                    </div>
                    <div class="col-md-4">
                        <label for="valeFecha" class="form-label">Fecha:</label>
                        <input type="date" class="form-control" value="{{ $fechaActual->format('Y-m-d') }}" id="valeFecha" name="valeFecha" readonly>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" aria-label="Default select example" name="valeDepartamento" id="choice1">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-2">
            ...
            <input type="number" placeholder="" class="form-control" name="valeEconomico" id="valeEconomico">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            ...
            <input type="text" placeholder="" class="form-control" name="valeCombustible" id="valeCombustible">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-2">
            ...
            <input type="number" placeholder="" class="form-control" name="valeAño" id="valeAño">

        </div>
        <div class="col-md-2">
            <label for="valeKilometraje" class="form-label">Kilometraje:</label>
            <input type="number" placeholder="" class="form-control" name="valeKilometraje" id="valeKilometraje">
        </div>
        <div class="col-md-2">
            <label for="valeLitros" class="form-label">Litros:</label>
            <input type="number" placeholder="" class="form-control" name="valeLitros" id="valeLitros">

        </div>
        <div class="col-md-4">
            <label for="valeCantidad" class="form-label">Cantidad:</label>
            <input type="text" placeholder="" class="form-control" name="valeCantidad" id="valeCantidad" readonly>
        </div>
    </div>
    <hr>
