            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="text"value="{{ $dato->empleadoNumero }}" placeholder="" class="form-control"
                            name="empleadoNumero" id="empleadoNumero">

                        <label for="empleadoNombre">Nombre del empleado:</label>
                        <input type="text" value="{{ $dato->empleadoNombre }}" placeholder="" class="form-control"
                            name="empleadoNombre" id="empleadoNombre">

                        <label for="empleadoPuesto">Puesto del empleado:</label>
                        <input type="text" value="{{ $dato->empleadoPuesto }}" placeholder="" class="form-control"
                            name="empleadoPuesto" id="empleadoPuesto">

                        <label for="empleadoDepartamento">Departamento del empleado:</label>
                        <select class="form-select" aria-label="Default select example" name="empleadoDepartamento"
