...
<link rel="stylesheet"
    ...
    $(document).ready(function() {
        var table1 = $('#tablaEmpleado').DataTable({
        ...
        <div class="card border-secondary mb-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="tablaEmpleado" class="table table-striped custom-table">
                        <thead>
                                    ...
                                    <td>
                                        <div class="container1">
                                            <a class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalX{{ $dato->id }}"><i class="fas fa-pen-square"
                                        ...
                                        <div class="modal fade" id="modalX{{ $dato->id }}" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Editar
                                                            informacion de <strong> {{ $dato->empleadoNombre }}
                                                            </strong>
                                                        </h1>
